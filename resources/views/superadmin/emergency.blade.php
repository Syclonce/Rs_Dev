            ...
            <div class="card">
                ...
                <div class="card-body">
                  <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                            @foreach($resikokerja as $resikokerja)
                            <tr>
                                <td>{{ $resikokerja->kode_emergency }}</td>
                                <td>{{ $resikokerja->nama_emergency }}</td>
                                <td>
                                    @if ($resikokerja->indexs == 1)
                                        aktif
                                    @elseif ($resikokerja->indexs == 2)
                                        tidak aktif
                                    @else
                                        Tidak ada status
                                    @endif
                                ...
                                <td>
                                    <a href="{{ route('superadmin.resikokerja', ['id' => $resikokerja->kode_emergency]) }}" class="btn btn-primary">
                                        Delete
                                    </a>
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('superadmin.emergency') }}" method="POST">
                    @csrf
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
