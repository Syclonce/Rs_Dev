                ...
                <div class="card-body">
                  <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>{{ $resikokerja->id }}</td>
                                <td>{{ $resikokerja->kode_kerja }}</td>
                                <td>{{ $resikokerja->nama_resiko }}</td>
                                <td>
                                    <a href="{{ route('superadmin.resikokerja', ['id' => $resikokerja->id]) }}" class="btn btn-primary">
                                        Delete
                                    </a>
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('superadmin.resikokerja') }}" method="POST">
                    @csrf
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
