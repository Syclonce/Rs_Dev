            ...
            <div class="card">
                ...
                <div class="card-body">
                  <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                            @foreach($metoderacik as $metoderacik)
                            <tr>
                                <td>{{ $metoderacik->id }}</td>
                                <td>{{ $metoderacik->kode_racik }}</td>
                                <td>{{ $metoderacik->nama_racik }}</td>
                                <td>
                                    <a href="{{ route('superadmin.metoderacik', ['id' => $metoderacik->id]) }}" class="btn btn-primary">
                                        Delete
                                    </a>
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('superadmin.metoderacik') }}" method="POST">
                    @csrf
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
